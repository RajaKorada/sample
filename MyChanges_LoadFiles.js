...
import {addSession, loadSessionList, loadSessionItem} from '../actions/sessions';
  ...
  render() {
    ...
    if(this.props.userData.length > 0){
        ...
        if(this.props.title === 'Workload'){
               ...
               return <Box key={index} separator='top' align='start'
              ...
              <Box direction="column" margin="none" pad="none" style={{width: '100%', height:'100%'}} >
                  ...
                  <Box className='LoadScrTileContainer' margin="none" pad="small" separator="bottom">
                       {/* <Tiles selectable={true}                        
                              //  selected={this.state.LoadItemIndex}
                               onSelect={ (e) => { this.setState({LoadItemIndex: e }); } }>
                              { TileItems }
                       </Tiles>   */}              
                       <Box direction="row" basis='1/4' margin="none" pad={{between:'small'}} style={{padding:'12px'}} >
                          { TileItems }
                       </Box>                                                                                              
                  </Box>     
